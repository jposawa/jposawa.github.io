 ...
 *
 * @help
 * The default plugin file name is DoubleX RMMV Popularized ATB Core v102d
...
DoubleX_RMMV["PATB Core"] = "v1.02d";

// The plugin file name must be the same as DoubleX_RMMV.PATB_Core_File
DoubleX_RMMV.PATB_Core_File = "DoubleX RMMV Popularized ATB Core v102d";
